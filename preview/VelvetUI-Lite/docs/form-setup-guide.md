# Velvet Studio Lite Inquiry Form Guide

The contact form is located in the contact section of `index.html` and sends visitors to `thank-you.html` after submission.

## Current Behavior

The form uses a static confirmation path for local review:
...
The JavaScript intercepts this local static flow so inquiry details are not appended to the URL. The confirmation page remains available at `thank-you.html`.
