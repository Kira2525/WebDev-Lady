# Velvet Studio Image Guide

Image and brand assets live in `assets/img/`.

## Brand Assets

* `assets/img/velvetui-mark.svg` - Diamond logo mark
* `assets/img/velvetui-favicon.svg` - Browser icon
* `assets/img/velvetui-og.svg` - Social sharing artwork

The compact navigation uses `assets/img/velvetui-mark.svg` as the diamond menu icon.
